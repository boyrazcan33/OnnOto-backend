...
public class CorsConfig {
    ...
    @Value("${onnoto.cors.allowed-origins:http://localhost:8080,https://onnoto.com,https://onnoto-frontend-production.up.railway.app/}")    private List<String> allowedOrigins;
